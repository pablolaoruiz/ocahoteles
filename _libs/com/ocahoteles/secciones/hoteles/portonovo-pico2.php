    ...
    return [
            ...
            $basenombre => [
                ...
                "inicio" => [
                    ...
                    "titulo" => "Apartamentos",
                    "meta_titulo" => "Apartamentos Duerming Bolera Pico en Portonovo, Sanxenxo. Apartamentos turísticos aptos para mascotas.",
                    "meta_descripcion" => "A escasos metros de la playa Baltar, apartamentos con cocina, baños, televisión...Todas las comodidades para disfrutar en familia de los encantos de Pontevedra. Apartamentos turísticos aptos para mascotas.",
                    "seccion_titulo" => "",
                    "seccion_descripcion" => "",
                    "lang" => "",
                    "slug" => "",
                ...
                "home" => [
                    ...
                    "titulo" => "Apartments",
                    "meta_titulo" => "Apartments Duerming Bolera Pico in Sanxenxo. Pet friendly tourist apartments.",
                    "meta_descripcion" => "A few meters from Baltar beach, apartments with kitchen, bathrooms, television ... All the amenities to enjoy with family the charms of Pontevedra. Pet friendly tourist apartments.",
                    "seccion_titulo" => "",
                    "seccion_descripcion" => "",
                    "lang" => "en",
                    "slug" => "",
