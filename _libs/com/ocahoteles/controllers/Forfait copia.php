...
class Forfait extends BBDD_PDO {
            ...
            if($dias == 2) {
                ...
                if($uno == $dos) {
                    if ($uno == 1) { //dos días alta
                        ...
                        $adultobaja2=$adultos_param; //adultos
                        $ninobaja2=$ninos_param; //ninos
                        $preinfantil2=$preinfantil_param; //preinfantil
                    }
                }
                else {
                ...
                if($uno == $dos) {
                    if ($uno == 1) { //dos días alta
                        ...
                        $adultobaja3=$adultos_param; //adultos
                        $ninobaja3=$ninos_param; //ninos
                        $preinfantil3=$preinfantil_param; //preinfantil
                    }
                }
                else {
                    $totales['misma_temporada']=false;
    ...
    public function obtenerForfaits($fecha) {
        ...
        global $appConfig;
           $query = $this->link->prepare("SELECT * FROM reservas_forfait WHERE fechaReserva=:fecha AND status=0");
	$query->execute(array(
		'fecha' => $fecha,
	...
	$result=$query->fetchAll();
        ...
        $to_email = "pablo@puraenvidia.com";
        $to_name = "Oca Manzaneda";
        $copy_email = "pablo@puraenvidia.com";
        ...
        $fechaReserva = $_POST["dateok"];
                        ...
                        $query = $this->link->prepare("INSERT INTO reservas_forfait (fecha,fechaReserva,dni,nombre,apellidos,email,telefono,adulto0,nino0,preinfantil0,adultoalta1,adultoalta2,adultobaja1,adultobaja2,ninoalta1,ninoalta2,ninobaja1,ninobaja2,preinfantil1,preinfantil2,total,totaladulto,totalnino,totalpreinfantil) VALUES (:fecha,:fechaReserva,:dni,:nombre,:apellidos,:email,:telefono,:adulto0,:nino0,:preinfantil0,:adultoalta1,:adultoalta2,:adultobaja1,:adultobaja2,:ninoalta1,:ninoalta2,:ninobaja1,:ninobaja2,:preinfantil1,:preinfantil2,:total,:totaladulto,:totalnino,:totalpreinfantil)");
        ...
        $query->execute(array(
            ...
            //"adultobaja3"=>$totales['adultobaja3'],
